...
class AlunoController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Id,Nome,Email,Curso,Sexo'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			// $aluno->Id = $this->SafeGetVal($json, 'id');

			$aluno->Nome = $this->SafeGetVal($json, 'nome');
			$aluno->Email = $this->SafeGetVal($json, 'email');
			$aluno->Curso = $this->SafeGetVal($json, 'curso');
			$aluno->Sexo = $this->SafeGetVal($json, 'sexo');
	...
	public function Update()
	{
		try
		{
			...
			// $aluno->Id = $this->SafeGetVal($json, 'id', $aluno->Id);

			$aluno->Nome = $this->SafeGetVal($json, 'nome', $aluno->Nome);
			$aluno->Email = $this->SafeGetVal($json, 'email', $aluno->Email);
			$aluno->Curso = $this->SafeGetVal($json, 'curso', $aluno->Curso);
			$aluno->Sexo = $this->SafeGetVal($json, 'sexo', $aluno->Sexo);
