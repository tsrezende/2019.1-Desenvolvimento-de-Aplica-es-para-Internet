...
GlobalConfig::$CONNECTION_SETTING->DBName = "cadaluno";
...
/** the root url of the application with trailing slash, for example http://localhost/cadaluno/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'cadaluno/';
