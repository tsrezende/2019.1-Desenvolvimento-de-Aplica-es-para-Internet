/**
 * backbone model definitions for ALUNOS
 */
...
/**
 * Cadastro Backbone Model
 */
model.CadastroModel = Backbone.Model.extend({
	urlRoot: 'api/cadastro',
	idAttribute: 'nome',
	nome: '',
	e-mail: '',
	curso: '',
...
/**
 * Cadastro Backbone Collection
 */
model.CadastroCollection = model.AbstractCollection.extend({
	url: 'api/cadastros',
	model: model.CadastroModel
});
