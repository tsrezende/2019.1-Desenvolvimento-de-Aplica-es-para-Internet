...
GlobalConfig::$CONNECTION_SETTING->DBName = "alunos";
...
/** the root url of the application with trailing slash, for example http://localhost/alunos/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'alunos/';
